...
def transform_data(database:str, table_source:str, table_target) -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Transforma dados de solicitações de serviço de Boston 311" 
    )
    parser.add_argument("--database", type=str, help="databaseGlueSYSTEM")
    parser.add_argument("--table_source", type=str, help="initial_table")
    parser.add_argument("--table_target", type=str, help="destiny_table")
